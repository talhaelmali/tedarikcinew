  ...
  return (
      ...
      <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
        <div className="px-6 pb-24 pt-10 sm:pb-32 lg:col-span-7 lg:px-0 lg:pb-56 lg:pt-48 xl:col-span-6">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            Hızlı ve Güvenli Ticaretin Adresi            </h1>
        ...
        <div className="relative lg:col-span-3 lg:-mr-8 xl:absolute xl:inset-0 xl:left-1/2 xl:mr-0">
          <img
            ...
            src="https://firebasestorage.googleapis.com/v0/b/ihale-6cb24.appspot.com/o/Banner%20image.png?alt=media&token=7350fd16-f6c4-4d91-b5d9-ed70024067c3"
            alt=""
          />
        </div>
      </div>
    ...
    <div className="bg-white py-24 sm:py-32">
      ...
      <img
        ...
        src="https://firebasestorage.googleapis.com/v0/b/ihale-6cb24.appspot.com/o/stats.png?alt=media&token=924ba276-d925-47ff-8f3a-e045885840f1"
        alt=""
      />
